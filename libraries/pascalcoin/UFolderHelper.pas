...
Type TFileVersionInfo = record
  ...
  public
    class function GetABEYDataFolder : string; static;
    class function GetContractStorageFolder : string; static;
    class function GetContractTempFolder : string; static;
    class function GetP2PFileSharingFolder : string; static;
...
class function TFolderHelper.GetABEYDataFolder: string;
begin
  {$IFDEF TESTNET}
  Result := GetAppDataFolder+PathDelim+'ABEY_testnet';
  {$ELSE}
  Result := GetAppDataFolder+PathDelim+'ABEY';
  {$ENDIF}
end;


class function TFolderHelper.GetContractStorageFolder: string;
begin
  {$IFDEF TESTNET}
  Result := GetAppDataFolder+PathDelim+'ABEY_testnet'+PathDelim+'Contracts'; ;
  {$ELSE}
  Result := GetAppDataFolder+PathDelim+'ABEY'+PathDelim+'Contracts';
  {$ENDIF}
end;

class function TFolderHelper.GetContractTempFolder : string; static;
begin
  {$IFDEF TESTNET}
  Result := GetAppDataFolder+PathDelim+'ABEY_testnet'+PathDelim+'Contracts'+PathDelim+'Temp';
  {$ELSE}
  Result := GetAppDataFolder+PathDelim+'ABEY'+PathDelim+'Contracts'+PathDelim+'Temp';
  {$ENDIF}
end;

class function TFolderHelper.GetP2PFileSharingFolder: string;
begin
  {$IFDEF TESTNET}
  Result := GetAppDataFolder+PathDelim+'ABEY_testnet'+PathDelim+'P2PFileSharing';  ;
  {$ELSE}
  Result := GetAppDataFolder+PathDelim+'ABEY'+PathDelim+'P2PFileSharing';
  {$ENDIF}
end;
