...
function TABEYUnitTest.ParseBytes(const AStr : String) : TBytes;
begin
...
procedure TABEYUnitTest.AssertEquals(const AMessage: string; const Expected, Actual: TBytes);
begin
{$IFDEF FPC}
...
procedure TABEYUnitTest.AssertEquals(const Expected, Actual: TBytes);
begin
{$IFDEF FPC}
