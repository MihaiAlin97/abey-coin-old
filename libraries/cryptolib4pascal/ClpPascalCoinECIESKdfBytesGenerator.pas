...
unit ClpABEYECIESKdfBytesGenerator;
...
type
  ...
  /// <summary>
  /// <para>
  /// KDF generator for compatibility with existing ABEY Implementation
  /// </para>
  /// </summary>
  TABEYECIESKdfBytesGenerator = class(TBaseKdfBytesGenerator,
    IABEYECIESKdfBytesGenerator)

  public

    /// <summary>
    /// Construct a ABEY compatible bytes generator.
    /// </summary>
    /// <param name="digest">
...
{ TABEYECIESKdfBytesGenerator }

constructor TABEYECIESKdfBytesGenerator.Create(const digest: IDigest);
begin
  Inherited Create(0, digest);
end;

function TABEYECIESKdfBytesGenerator.GenerateBytes
...
procedure TABEYECIESKdfBytesGenerator.Init(const parameters
