...
type
  ...
  /// <summary>
  /// Compatibility Class for ABEY IESEngine
  /// </summary>
  TABEYIESEngine = class(TIESEngine, IABEYIESEngine)

  strict private
  type
    /// <summary>
    /// Structure for Compatibility with ABEY Original
    /// Implementation.
    /// </summary>
    TSecureHead = record
      Key: Byte;
...
function TABEYIESEngine.DecryptBlock(const in_enc: TCryptoLibByteArray;
...
function TABEYIESEngine.EncryptBlock(const &in: TCryptoLibByteArray;
  inOff, inLen: Int32): TCryptoLibByteArray;
var
...
function TABEYIESEngine.ProcessBlock(const &in: TCryptoLibByteArray;
  inOff, inLen: Int32): TCryptoLibByteArray;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        // for existing ABEY compatiblity purposes
