...
type
  ...
  type
    ...
    /// Initializes a new instance of the <see cref="TABEYg"/> class
...
class function TABEYg.NextUInt32(): UInt32;
var
...
class function TABEYg.NextUInt32(minimum: UInt32; exclusiveBound: UInt32): UInt32;
var
...
class function TABEYg.Range32(exclusiveBound: UInt32): UInt32;
var
  r, threshold: UInt32;
begin
...
class procedure TABEYg.Seed(initState: UInt64; initSeq: UInt64);
begin
  Fm_state := UInt32(0);
...
class function TABEYg.GetInitSeq(tempVal: UInt64): UInt64;

begin
  result := tempVal * UInt64(181783497276652981);
end;

class function TABEYg.GetInitState(out initSeq: UInt64): UInt64;
...
// static class constructor
class constructor TABEYg.Create();
var
...
constructor TABEYg.Create(initState: UInt64; initSeq: UInt64);
begin
  Seed(initState, initSeq);
end;

class function TABEYg.NextInt(minimum: Integer; exclusiveBound: Integer): Integer;
var
  boundRange, rangeResult: UInt32;
begin
