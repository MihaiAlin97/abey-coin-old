...
{ TABEYOpenSSLSignature }

class function TABEYOpenSSLSignature.DoECDSASign(const AEC_OpenSSL_NID: Word; APEC_KEY : PEC_KEY; const AMessage: TBytes; var ASignature: TECDSA_SIG): Boolean;
Var PECS : PECDSA_SIG;
  p : PAnsiChar;
  i : Integer;
begin
...
class function TABEYOpenSSLSignature.DoECDSAVerify(const APublicKey: TECDSA_Public; const AMessage: TBytes; const ASignature: TECDSA_SIG): Boolean;
Var BNx,BNy : PBIGNUM;
  ECG : PEC_GROUP;
  ctx : PBN_CTX;
  pub_key : PEC_POINT;
