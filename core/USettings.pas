...
const
  ...
  CT_PARAM_MinFutureBlocksToDownloadNewVault = 'MinFutureBlocksToDownloadNewVault';
...
type
  ...
  TSettings = class
    private
      ...
      class function GetMinFutureBlocksToDownloadNewVault: Integer; static;
      ...
      class procedure SetMinFutureBlocksToDownloadNewVault(AInt: Integer); static;
    ...
    public
      ...
      class property MinFutureBlocksToDownloadNewVault : Integer read GetMinFutureBlocksToDownloadNewVault write SetMinFutureBlocksToDownloadNewVault;
...
class function TSettings.GetMinFutureBlocksToDownloadNewVault: Integer;
begin
  CheckLoaded;
  Result := FAppParams.ParamByName[CT_PARAM_MinFutureBlocksToDownloadNewVault].GetAsInteger(0);
end;
...
class procedure TSettings.SetMinFutureBlocksToDownloadNewVault(AInt: Integer);
begin
  CheckLoaded;
  FAppParams.ParamByName[CT_PARAM_MinFutureBlocksToDownloadNewVault].SetAsInteger(AInt);
end;
