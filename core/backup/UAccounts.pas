...
Type
  ...
  public
    ...
    class function ReadAnsiStringCustom(Stream: TStream; var value: TRawBytes): Integer;
    class function WriteAnsiStringCustom(Stream: TStream; const value: TRawBytes): Integer;
...
begin
  ...
  DebugLn('Reading payload size'+IntTOStr(w));
  SetLength(value, w);
  if (w>0) then begin
...
class function TStreamOp.ReadAnsiStringCustom(Stream: TStream; var value: TRawBytes): Integer;
Var
  w: integer;
begin
...
class function TStreamOp.WriteAnsiStringCustom(Stream: TStream; const value: TRawBytes): Integer;
Var
  w: integer;
begin
  //there was a limit here before
  w := Length(value);
  Stream.WriteDWord(w);
